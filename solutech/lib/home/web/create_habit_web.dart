...
class CreateHabitWeb extends StatefulWidget {
  final Habit? habit;

  const CreateHabitWeb({super.key, this.habit});

  @override
  State<CreateHabitWeb> createState() => _CreateHabitWebState();
}

class _CreateHabitWebState extends State<CreateHabitWeb> {
