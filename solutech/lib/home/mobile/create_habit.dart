...
class CreateHabitMobile extends StatefulWidget {
  final Habit? habit;

  const CreateHabitMobile({super.key, this.habit});

  @override
  State<CreateHabitMobile> createState() => _CreateHabitMobileState();
}

class _CreateHabitMobileState extends State<CreateHabitMobile> {
